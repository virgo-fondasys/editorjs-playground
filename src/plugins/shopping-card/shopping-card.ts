...
export default class ShoppingCard {
  ...
  render() {
    const wrapper = makeElement<HTMLDivElement>("div", ["shopping-card"]);
  ...
  save() {
    const inputs = Array.from(
      document.querySelectorAll(".shopping-card__input")
    ) as HTMLInputElement[];
    const textareas = Array.from(
      document.querySelectorAll(".shopping-card__textarea")
